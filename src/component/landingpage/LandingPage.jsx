    ...
    <>
      ...
      <div className={styles.popular}>
        <span className={styles.card1}>
          ...
          <p>
            A community of people of African descent from all around the world.
          </p>
          <div className={styles.avaterbtn}>
      ...
      <div className={styles.deeply}>
        ...
        <p>
          Explore our wide range of products, and get solutions to every of your
          needs
        </p>
      </div>
      <div className={styles.socialContainer}>
        <div className={styles.social} onClick={handleSocialSignin}>
          <div className={styles.imag}>
            ...
            <p className={styles.psocial}>
              Stay connected with family and friends. Start a group and join a
              conversation.
            </p>
        ...
        <div className={styles.social7}>
          <div className={styles.imag}>
            ...
            <p className={styles.psocial}>
              Stay connected and engaged with our vibrant lineup of events and
              concerts
            </p>
            <span className={styles.span}>View More </span>
            <img
