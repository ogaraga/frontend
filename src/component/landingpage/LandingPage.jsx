          ...
          <main className={styles.mains}>
            <div className={styles.celebrating}>
              <h4>
                ...
                <b style={{ color: "green" }}>Connecting Communities, </b>
                Enriching lives
              </h4>
              <p className={styles.celep}>
                Join us in building dynamic social networks that honor your
                heritage and foster meaningful connections. Discover a space
                where you can truly be yourself and embrace your community.
              </p>
            ...
            <div className={styles.communities}>
              <h1>Communities</h1>
              <p>
                Join communities and conversations that fits your interests.
              </p>
            </div>
            <h1 className={styles.h1popular}>
              Popular Communities you can join.
            </h1>
            <div className={styles.popular}>
              ...
              <div className={styles.card2}>
                ...
                <p>
                  A group of people of Filipino descent from all arround the
                  world
                </p>
                <span className={styles.avaterbtn}>
                  <img src={avatabtn} alt="image" />
              ...
              <div className={styles.deeply}>
                ...
                <p>
                  Explore our wide range of products, and get solutions to every
                  of your needs
                </p>
              </div>
              <div className={styles.socialContainer}>
                <div className={styles.social} onClick={handleSocialSignin}>
                  <div className={styles.imag}>
                    ...
                    <p className={styles.psocial}>
                      Stay connected with family and friends. Start a group and
                      join a conversation.
                    </p>
                ...
                <div className={styles.social4}>
                  <div className={styles.imag}>
                    ...
                    <p className={styles.psocial}>
                      Indulge in a culinary journey that celebrates the
                      Afrocentric cuisine.
                    </p>
                    <span className={styles.span}>View More </span>
                    <img
                ...
                <div className={styles.social6}>
                  <div className={styles.imag}>
                    ...
                    <p className={styles.psocial}>
                      Perform monetary transactions with ease and utmost
                      security.
                    </p>
                    <span className={styles.span}>View More </span>
                    <img
                ...
                <div className={styles.social7}>
                  <div className={styles.imag}>
                    ...
                    <p className={styles.psocial}>
                      Stay connected and engaged with our vibrant lineup of
                      events and concerts
                    </p>
                    <span className={styles.span}>View More </span>
                    <img
